...
- [ ] `debug/debug-e3f1c2-2026-07-15T13:05-install-global-exec-bit.md` — install:global produces non-executable devx (dist/cli.js missing +x). Status: ready. From: user report 2026-07-15.
