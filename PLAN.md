...
- [/] `plan/plan-b3f7a1-2026-07-14T10:40-portability-install.md` — Track 1 — Portability & install (packaged skills, real `devx init` scaffold, S-5 on palateful). Status: in-planning (PRD gate passed 2026-07-14; stage: design). Blocked-by: —.
