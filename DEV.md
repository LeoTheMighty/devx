...
- [/] `dev/dev-pin104-2026-07-14T12:03-install-global-sha-docs.md` — install:global + SHA provenance + docs-to-reality. Status: in-progress. Blocked-by: pin101. Parallel-safe with pin102/pin103.
