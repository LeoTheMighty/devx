...
- [ ] `dev/dev-5c215e-2026-09-21T12:10-s1-full-run-prose-budget.md` — S-1: give the full-run prose surface its own deliberate budget (separate knob from the planning gate; replaces the 2× drift tripwire; D-14; answers INTERVIEW Q#9). Status: ready. Blocked-by: —.
