...
- [/] `dev/dev-v2l101-2026-07-05T13:06-overnight-loop.md` — V2.5 overnight loop (gnhf fold-in: iteration contract, failure ladder, budgets, morning report). Status: in-progress. Blocked-by: v2d101, roc101.
