...
- [/] `dev/dev-rtl105-2026-07-30T09:31-init-hook-distribution.md` — Hook registration template + `/devx-init` distribution (E-8). Status: in-progress. Blocked-by: rtl101. Parallel-safe with rtl103/rtl104.
