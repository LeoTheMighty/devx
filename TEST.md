...
- [ ] `test/test-sgr103-qa-walkthrough.md` — QA walkthrough for "Renderer + `devx graph` CLI (write/stdout/check/json/scoping) + initial GRAPH.md"; 3 human check(s) outstanding (GitHub Mermaid render, glyph distinctness, dark-mode legibility — AC 7's attended leg). Status: ready. From: sgr103.
