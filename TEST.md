...
- [ ] `test/test-b7f2c1-2026-07-29T11:46-unidentified-suite-flake.md` — Identify + fix the 1-in-2,665 load-sensitive suite flake, and make long gate runs persist failure detail (the red run's name was lost to a truncated capture). Status: ready. From: mlcret (post-merge gate red, unreproducible on re-run).
