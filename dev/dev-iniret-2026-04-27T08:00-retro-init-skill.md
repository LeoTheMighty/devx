...
- [x] PR merged with the LEARN.md update
...
- 2026-04-27 — merged via PR #30 (squash → 2634254) on green CI (devx-ci, both macos + ubuntu Node 20). Phase 0 — Foundation closed.
