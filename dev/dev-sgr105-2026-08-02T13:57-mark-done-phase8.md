...
- 2026-08-05T14:35 — phase 7: CI success — devx-ci (run 31042124974). The push after the main-merge triggered the run immediately, closing Q#16's loop: the trigger was never broken, the PR was unmergeable.
